...
<head>
    ...
    <title>Кухонна техніка | KitchenTech</title>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <a href="#"><i class="fas fa-envelope"></i> info@kitchentech.ua</a>
                <a href="#"><i class="fas fa-map-marker-alt"></i> Київ, вул. Куховарська 15</a>
        ...
        <div class="copyright">
            &copy; 2023 KitchenTech. Всі права захищені.
        </div>
    </footer>
