...
class TVMediaModel {
    public function getAll($params, $pdo) {
        ...
        try {
            $sql = "SELECT * FROM tv_media WHERE 1=1";
            $count_sql = "SELECT COUNT(*) FROM tv_media WHERE 1=1";
            $query_params = [];
            $count_params = [];
            ...
            $this->addFilterCondition($sql, $count_sql, $query_params, $count_params, 'resolution', $params['resolutions']);
            $this->addFilterCondition($sql, $count_sql, $query_params, $count_params, 'size', $params['sizes']);
            $this->addFilterCondition($sql, $count_sql, $query_params, $count_params, 'technology', $params['technologies']);
