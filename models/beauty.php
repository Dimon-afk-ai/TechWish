...
class BeautyHealthModel {
    public function getAll($params, $pdo) {
        ...
        try {
            $sql = "SELECT * FROM beauty_health WHERE 1=1";
            $count_sql = "SELECT COUNT(*) FROM beauty_health WHERE 1=1";
            $query_params = [];
            $count_params = [];
            ...
            $this->addFilterCondition($sql, $count_sql, $query_params, $count_params, 'purpose', $params['purposes']);
